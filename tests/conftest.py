...
import logging
# DISABLED: Document class no longer exists (removed with FAISSRetriever)
...
# DISABLED: Document class no longer exists - replaced by database-backed retrieval
# This fixture is not used by any tests
# @pytest.fixture
